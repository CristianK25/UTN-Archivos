...
export function Sidebar({ 
  ...
  return (
    <div className="sticky top-20 h-[calc(100vh-5rem)] w-64 min-w-64 bg-gradient-to-b from-slate-50 to-slate-100 border-r border-slate-200 shadow-lg z-40 flex-shrink-0">
